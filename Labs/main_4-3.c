...
int main(void) {
    ...
    while(1) {
        ...
        IEC0bits.INT0IE = 0; //enable interrupt for S5 button
        time ++; // increase time every second
        IEC0bits.INT0IE = 1; //disable interrupt for S5 button
